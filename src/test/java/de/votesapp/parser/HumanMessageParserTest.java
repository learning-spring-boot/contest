...
public class HumanMessageParserTest {
    ...
    HumanMessageParser humanMessageParser = new HumanMessageParser(positives,
	    negatives, unkowns);
	...
	assertThat(
		humanMessageParser.parse("Status " + positives[0]),
	...
	assertThat(
		humanMessageParser.parse("Status " + negatives[0]),
